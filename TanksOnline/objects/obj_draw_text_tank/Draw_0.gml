...
if ( (real(hp)>=1) and (!place_meeting(x,y,obj_xy_place)) )
	{
		if !(string(bb)=="6")
		{
			draw_sprite_ext(s_hp,real(hp),x,y-77.5,0.17, 0.17, 0.5, -1, 1);
			draw_set_colour(c_orange);
			draw_text(x,y-97.5,string(username));
		}
	}
}
...
if ( (global.hp>0) )
{
	...
	draw_sprite_ext(s_hp,real(global.hp),ObjPlayer.x,ObjPlayer.y-85,0.17, 0.17 ,0, -1, image_alpha);
	draw_text(ObjPlayer.x,ObjPlayer.y-115,string(tarasbulba));
}
