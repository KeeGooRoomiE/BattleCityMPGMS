...
if (wview >1090)
{
	...
	draw_text(_x+160,_y+264,"Online: "+string(global.p_online)); 
	draw_sprite(spr_z7, global.nwpl, _x+245,_y+270);
}else{
	draw_sprite(spr_asset_7, image_index, _x,_y+143);
	draw_text(_x+20,_y+152,"Online: "+string(global.p_online)); 
	draw_sprite(spr_z7, global.nwpl, _x+120,_y+160);
}
