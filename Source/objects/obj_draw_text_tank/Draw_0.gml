...
if ( (global.hp>0) )
{
	draw_sprite_ext(Death_antibooster, real(global.bb), ObjPlayer.x, ObjPlayer.y, 0.75, 0.75, 0, -1, 0.7);
	draw_sprite_ext(spr_timer, real(bbtimertrue), ObjPlayer.x, ObjPlayer.y, 0.75, 0.75, 0, -1, 0.7);
